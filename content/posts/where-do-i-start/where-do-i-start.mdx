---
path: '/where-do-i-start'
date: '2020-04-07'
title: 'Where Do I Start?'
author: 'Craig Booker'
slug: 'where-do-i-start'
description: ' One of the more challenging tasks for aspiring developers is deciding where to start. Here I hope to give three steps to get started in software development'
category: 'software'
series: 'Zero To Dev'
tags:
  - 'zero to dev'
cover: './images/where-do-i-start.jpg'
draft: false
---
